...
def get_weather(city: str):
    ...
    """
    try:
        api_key="9cee9e2bdb50d8056b0e5e3b2e3ee0ee"
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="15e5f1d8dd724ff8afa989915985f6db"
...
def find_local_events(city: str):
    ...
    try:
        api_key="35596235684815e9551521848b37b5e978505bd9a890050e1b4191bdbbea319d"
